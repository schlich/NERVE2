...
% [upperleft_X, upperleft_Y, lowerright_X, lowerright_Y pixel positions
upperleftscreen = [0, 0, 1680, 1050];
lowerleftscreen = [0, 1051, 1680, 2100];
lowerrightscreen = [1681,1076, 2960, 2100];

[X_LL, Y_LL] = getScreenCenterPos(lowerleftscreen);
[X_LR, Y_LR] = getScreenCenterPos(lowerrightscreen);
...
screenid = 1; % full-display mode (screen 0) spans all windows
[win, winRect] = PsychImaging('OpenWindow', 0, blueVec,[1681,1051, 2960, 2100],[],[]);
...
for i=1:5
centerOut = 1; % Set to true for center out task. Target appears at (0,0).
